...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'newsletter.newsletter': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'header_reply': ('django.db.models.fields.CharField', [], {'default': "'noreply@winning-without-losing.com'", 'max_length': '255'}),
            'header_sender': ('django.db.models.fields.CharField', [], {'default': "'noreply@winning-without-losing.com'", 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
